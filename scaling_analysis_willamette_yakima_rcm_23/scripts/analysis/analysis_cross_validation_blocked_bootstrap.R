...
model_results <- read_csv(paste(results,"guerrero_etal_23_results_block_bootstrap_scaling.csv",
...
write.csv(combined_results,
          file = paste(results,"guerrero_etal_23_results_cross_validation_block_bootstrap_scaling.csv",
                       sep = '/'),
          row.names = FALSE)
